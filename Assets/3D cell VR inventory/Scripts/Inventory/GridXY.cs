...
{    
    ...
    public class GridXY
    {
        ...
        public void PlaceItem(Transform _item, InventoryCellObject cell, AxisDirections ñellOrientationAxis = default)
        {
            ...
            itemdata.item.transform.localRotation = Quaternion.Euler(ItemData.CalculateDirection(ñellOrientationAxis));
        ...
        public void Trigger_CellIntersected(InventoryCellObject inventoryCell, Transform ghostObject, AxisDirections directionAxis = default)
        {
            OnCellIntersected?.Invoke(this, new CellIntersectedEventArgs { cellObject = inventoryCell, item = ghostObject, DirectionAxis = directionAxis });
        }
